...
#ifndef _MAJORVER
#error _MAJORVER not defined
#endif

#ifndef _MINORVER
#error _MINORVER not defined
#endif

#ifndef _PATCHVER
#error _PATCHVER not defined
#endif
...
#define MAJORVER TEXT(MACRO_EXPANSION_TO_STR(_MAJORVER))
#define MINORVER TEXT(MACRO_EXPANSION_TO_STR(_MINORVER))
#define PATCHVER TEXT(MACRO_EXPANSION_TO_STR(_PATCHVER))
...
#define NUMBERFLAG TEXT(MACRO_EXPANSION_TO_STR(_NUMBERFLAG))
